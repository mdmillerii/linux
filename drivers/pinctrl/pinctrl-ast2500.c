...
#define A11 128 /* GPIOQ0 */
#define A10 129 /* GPIOQ1 */
#define A9  130 /* GPIOQ2 */
#define B9  131 /* GPIOQ3 */
#define N21 132 /* GPIOQ4 */
#define N22 133 /* GPIOQ5 */
#define B10 134 /* GPIOQ6 */
#define N20 135 /* GPIOQ7 */
...
/* I2C3, I2C4, I2C14 */
FUNC_EXPR_DECL_SINGLE(I2C3, FUNC_DESC_SET(SCU90, 16));
FUNC_EXPR_DECL_SINGLE(I2C4, FUNC_DESC_SET(SCU90, 17));
FUNC_EXPR_DECL_SINGLE(I2C14, FUNC_DESC_SET(SCU90, 27));

SS_PIN_DECL(A11, GPIOQ0, I2C3);
SS_PIN_DECL(A10, GPIOQ1, I2C3);
SS_PIN_DECL(A9, GPIOQ2, I2C4);
SS_PIN_DECL(B9, GPIOQ3, I2C4);
SS_PIN_DECL(N21, GPIOQ4, I2C14);
SS_PIN_DECL(N22, GPIOQ5, I2C14);
...
SS_PIN_DECL(L3, GPIOK0, I2C5);
SS_PIN_DECL(L4, GPIOK1, I2C5);
SS_PIN_DECL(L1, GPIOK2, I2C6);
SS_PIN_DECL(N2, GPIOK3, I2C6);
SS_PIN_DECL(N1, GPIOK4, I2C7);
SS_PIN_DECL(P1, GPIOK5, I2C7);
SS_PIN_DECL(P2, GPIOK6, I2C8);
SS_PIN_DECL(R1, GPIOK7, I2C8);
